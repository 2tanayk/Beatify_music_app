...
public class SearchFragmentAdapter extends FirestoreRecyclerAdapter<Music, SearchFragmentAdapter.MyViewHolder> {
     ...
     * @param options
     */
    public SearchFragmentAdapter(@NonNull FirestoreRecyclerOptions<Music> options) {
        super(options);
    }
